    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
            href="https://github.com/Moaz-Allam"
            target="_blank"
          ...
          <Link
            href="https://www.linkedin.com/in/moaz-allam-b076b7247/"
            target="_blank"
          ...
          <Link
            href="https://www.researchgate.net/profile/Moaz-Allam"
            target="_blank"
      ...
      >
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Cairo,
            Egypt.
          </p>
        </motion.div>
      </div>
